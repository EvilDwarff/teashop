...
export default function Header() {
  ...
  return (
    <div className="sticky top-0 left-0 w-full z-50 bg-white shadow-md flex items-center justify-between px-8 py-6">
      ...
      <nav
        className={`${montserrat.className} flex flex-1 justify-center space-x-8 font-medium text-gray-700 uppercase`}
      >
        ...
        <Link href="/#blog" className="hover:text-gray-900 cursor-pointer">
          Blog
        </Link>
